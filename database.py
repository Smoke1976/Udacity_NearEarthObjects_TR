...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        :param neo_by_des: A dict of 'NearEarthObject's by designation
        :param neo_by_name: A dict of 'NearEarthObject's by name
        :param hazardous_neos: A dict of hazardous 'NearEarthObject's only
        ...
        self.hazardous_neos = {neo.designation: neo for neo in neos
    ...
    def query(self, filters=()):
        """Query close approaches to find matches with specified filters.
        ...
        The `CloseApproach` objects are generated in internal order, which is
        not guaranteed to be sorted meaningfully, although is often sorted by
        time.
